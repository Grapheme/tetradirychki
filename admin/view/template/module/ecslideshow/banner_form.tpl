                ...
                <div id="tab-language-<?php echo $image_row; ?>-<?php echo $language['language_id']; ?>">
                  <table class="form">
                    ...
                    <tr>
                      ...
                      <td><textarea  cols="25" rows="10" style="width:500px;heigt:400px" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][custom_code]" id="custom_code-<?php echo $image_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($banner_image['banner_image_description'][$language['language_id']]['custom_code']) ? $banner_image['banner_image_description'][$language['language_id']]['custom_code'] : ''; ?></textarea></td>
                    </tr>
                  </table>
                </div>
                <?php } ?>
