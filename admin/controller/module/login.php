...
class ControllerModuleLogin extends Controller {
	...
	public function index() {
	    ...
	    if (isset($this->request->post['login_module'])) {
			$this->data['modules'] = $this->request->post['login_module'];
		} elseif ($this->config->get('login_module')) { 
			$this->data['modules'] = $this->config->get('login_module');
		}	
