		...
		<!-- MAIN CONTENT -->
				<div class="col-xs-12 col-sm-8  <?php if(isset($themeSettings['cartpagelayout']) && $themeSettings['cartpagelayout']!=''){ echo $themeSettings['cartpagelayout']; } else { echo 'col-lg-9'; }?> main">
				  ...
				  <div class="checkout">
					<div id="checkout">
					  <div class="checkout-heading"><i class="icon-settings3"></i><?php echo $text_checkout_option; ?></div>
					  <div class="checkout-content"></div>
					</div>
					<?php if (!$logged) { ?>
					<div id="payment-address">
					  <div class="checkout-heading"><span><i class="icon-location"></i><?php echo $text_checkout_account; ?></span></div>
					  <div class="checkout-content"></div>
					</div>
					<?php } else { ?>
					<div id="payment-address">
					  <div class="checkout-heading"><span><i class="icon-envelope2"></i><?php echo $text_checkout_payment_address; ?></span></div>
					  <div class="checkout-content"></div>
					</div>
					<?php } ?>
					<?php if ($shipping_required) { ?>
					<div id="shipping-address">
					  <div class="checkout-heading"><i class="icon-meter"></i><?php echo $text_checkout_shipping_address; ?></div>
					  <div class="checkout-content"></div>
					</div>
					<div id="shipping-method">
					  <div class="checkout-heading"><i class="icon-truck"></i><?php echo $text_checkout_shipping_method; ?></div>
					  <div class="checkout-content"></div>
					</div>
					<?php } ?>
					<div id="payment-method">
					  <div class="checkout-heading"><i class="icon-coin"></i><?php echo $text_checkout_payment_method; ?></div>
					  <div class="checkout-content"></div>
					</div>
					<div id="confirm">
					  <div class="checkout-heading"><i class="icon-compose"></i><?php echo $text_checkout_confirm; ?></div>
					  <div class="checkout-content"></div>
					</div>
				  </div>
				</div>
...
$('#button-account').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-account').after('<span class="wait">&nbsp;<img src="catalog/view/theme/commerca/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
...
$('#button-login').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-login').after('<span class="wait">&nbsp;<img src="catalog/view/theme/commerca/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-register').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-register').after('<span class="wait">&nbsp;<img src="catalog/view/theme/commerca/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/commerca/image/close.png" alt="" class="close" /></div>');
...
$('#button-payment-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-payment-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/commerca/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-shipping-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-shipping-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/commerca/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/commerca/image/close.png" alt="" class="close" /></div>');
...
$('#button-guest').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest').after('<span class="wait">&nbsp;<img src="catalog/view/theme/commerca/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-guest-shipping').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest-shipping').after('<span class="wait">&nbsp;<img src="catalog/view/theme/commerca/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-shipping-method').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-shipping-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/commerca/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/commerca/image/close.png" alt="" class="close" /></div>');
...
$('#button-payment-method').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-payment-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/commerca/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/commerca/image/close.png" alt="" class="close" /></div>');
