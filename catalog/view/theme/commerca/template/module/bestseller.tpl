	...
	?>
	<!-- Bestseller products -->
	<div class="section carousel-container <?php echo $themeSettings['bestresponsive']; ?> <?php echo $themeSettings['bestresponsivesm']; ?> <?php echo $themeSettings['bestresponsivemd']; ?> <?php echo $themeSettings['bestresponsivelg']; ?>">
		<div class="container">
								...
								<li>
									<div class="product">
										<a href="<?php echo $product['href']; ?>" class="product-link clearfix">
											...
											<?php } else { ?>
											<?php if(isset($themeSettings['bestribbon'])){ if($themeSettings['bestribbon'] == 'hot') { ?>
											<div class="ribbon special"><?php echo $this->language->get( 'text_hot' ); ?></div>
											<?php } elseif(isset($themeSettings['bestribbon'])){ if($themeSettings['bestribbon'] == 'new') { ?>
											<div class="ribbon special"><?php echo $this->language->get( 'text_new' ); ?></div>
											<?php } elseif(isset($themeSettings['bestribbon'])){ if($themeSettings['bestribbon'] == 'disable') { ?>
