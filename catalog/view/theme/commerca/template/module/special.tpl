	...
	?>
	<!-- Special products -->
	<div class="section carousel-container <?php echo $themeSettings['specialresponsive']; ?> <?php echo $themeSettings['specialresponsivesm']; ?> <?php echo $themeSettings['specialresponsivemd']; ?> <?php echo $themeSettings['specialresponsivelg']; ?>">
		<div class="container">
								...
								<li>
									<div class="product">
										<a href="<?php echo $product['href']; ?>" class="product-link clearfix">
											...
											<?php } else { ?>
											<?php if(isset($themeSettings['specialribbon'])){ if($themeSettings['specialribbon'] == 'hot') { ?>
											<div class="ribbon special"><?php echo $this->language->get( 'text_hot' ); ?></div>
											<?php } elseif(isset($themeSettings['specialribbon'])){ if($themeSettings['specialribbon'] == 'new') { ?>
											<div class="ribbon special"><?php echo $this->language->get( 'text_new' ); ?></div>
											<?php } elseif(isset($themeSettings['specialribbon'])){ if($themeSettings['specialribbon'] == 'disable') { ?>
