<!-- CATEGORIES LIST -->
	<div class="section module-list-items <?php echo $themeSettings['accountresponsive']; ?> <?php echo $themeSettings['accountresponsivesm']; ?> <?php echo $themeSettings['accountresponsivemd']; ?> <?php echo $themeSettings['accountresponsivelg']; ?>">
