...
<!-- CATEGORIES LIST -->
	<div class="section module-list-items <?php echo $themeSettings['filterresponsive']; ?> <?php echo $themeSettings['filterresponsivesm']; ?> <?php echo $themeSettings['filterresponsivemd']; ?> <?php echo $themeSettings['filterresponsivelg']; ?>">
