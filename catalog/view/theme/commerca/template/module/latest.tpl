	...
	?>
	<!-- Latest products -->
	<div class="section carousel-container <?php echo $themeSettings['latestresponsive']; ?> <?php echo $themeSettings['latestresponsivesm']; ?> <?php echo $themeSettings['latestresponsivemd']; ?> <?php echo $themeSettings['latestresponsivelg']; ?>">
		<div class="container">
								...
								<li>
									<div class="product">
										<a href="<?php echo $product['href']; ?>" class="product-link clearfix">
											...
											<?php } else { ?>
											<?php if(isset($themeSettings['latestribbon'])){ if($themeSettings['latestribbon'] == 'hot') { ?>
											<div class="ribbon special"><?php echo $this->language->get( 'text_hot' ); ?></div>
											<?php } elseif(isset($themeSettings['latestribbon'])){ if($themeSettings['latestribbon'] == 'new') { ?>
											<div class="ribbon special"><?php echo $this->language->get( 'text_new' ); ?></div>
											<?php } elseif(isset($themeSettings['latestribbon'])){ if($themeSettings['latestribbon'] == 'disable') { ?>
