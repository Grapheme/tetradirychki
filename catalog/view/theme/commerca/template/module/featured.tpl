...
?>
	<!-- Featured products -->
	<div class="section carousel-container <?php echo $themeSettings['featuredresponsive']; ?> <?php echo $themeSettings['featuredresponsivesm']; ?> <?php echo $themeSettings['featuredresponsivemd']; ?> <?php echo $themeSettings['featuredresponsivelg']; ?>">
		<div class="container">
								...
								<li>
									<div class="product">
										<a href="<?php echo $product['href']; ?>" class="product-link clearfix">
											...
											<?php } else { ?>
											<?php if(isset($themeSettings['featuredribbon'])){ if($themeSettings['featuredribbon'] == 'hot') { ?>
											<div class="ribbon special"><?php echo $this->language->get( 'text_hot' ); ?></div>
											<?php } elseif(isset($themeSettings['featuredribbon'])){ if($themeSettings['featuredribbon'] == 'new') { ?>
											<div class="ribbon special"><?php echo $this->language->get( 'text_new' ); ?></div>
											<?php } elseif(isset($themeSettings['featuredribbon'])){ if($themeSettings['featuredribbon'] == 'disable') { ?>
