	...
	<div id="wrap-container">
		...
		<div class="main-content ">
			<div class="container">
				...
				<!-- MAIN CONTENT -->
				<div class="col-xs-12 col-sm-8  <?php if(isset($themeSettings['catpagelayout']) && $themeSettings['catpagelayout']!=''){ echo $themeSettings['catpagelayout']; } else { echo 'col-lg-9'; }?> main section">
				...
				<!-- PRODUCT AREA -->
				<div id="product-list-container" class="section offer products-container portrait" data-layout="<?php if(isset($themeSettings['specialcategorylist']) && $themeSettings['specialcategorylist']!=''){ echo $themeSettings['specialcategorylist']; } else { echo 'grid'; }?>">
				 <?php if ($products) { ?>
					<div class="row">
