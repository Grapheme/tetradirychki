							...
							<div class="col-xs-12 col-sm-8 <?php if(isset($themeSettings['catpagelayout']) && $themeSettings['catpagelayout']!=''){ echo $themeSettings['catpagelayout']; } else { echo 'col-lg-9'; }?> main">
								...
								<div class="section product-single">
									...
									<div class="col-xs-12 col-sm-6">
										<?php if ($thumb) { ?>
										<div class="image">
											<a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom" id='zoom1' rel="showTitle: false, position: 'right', smoothMove:3, adjustX: 20, adjustY: -2" data-rel="prettyPhoto">
										...
										<div class="row">
											<ul class="product-gallery clearfix">
											
												<li>
													<a href="<?php echo $popup; ?>" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo $thumb; ?>' ">
														<img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
													</a>
												</li>
												<?php foreach ($images as $image) { ?>
												<li>
													<a href="<?php echo $image['thumb']; ?>" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo $image['thumb']; ?>' ">
									...
									<?php } ?>
										...
										<div class="col-xs-8 col-sm-6">
											<div class="productpage-info clearfix">
												...
												<?php if ($price) { ?>
												<?php if (!$special) { ?>
													<div class="prices"><?php echo $price; ?></div>
												<?php } else { ?>
													<div class="prices"><span class="off-price"><?php echo $special; ?> - </span><s class="orginal-price"><?php echo $price; ?></s></div>
												<?php } ?>
												<?php } ?>
												<?php if ($tax) { ?>
												...
												<?php if ($profiles): ?>
												  ...
												  <!-- /CART AND LINK CONTENT -->
													...
													<div class="qty-btngroup">
														<button type="button" class="minus">-</button>
														 <input type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" id="qty-input" />
														<input type="hidden" name="product_id" size="2" value="<?php echo $product_id; ?>" />
														<button type="button" class="plus">+</button>
													</div>
													<div class="space50 clearfix"></div>
													<div class="add-to-cart">
														<input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="btn btn-primary btn-iconed"/>
													</div>
													<ul class="links">
												  ...
												  <div class="review">
													<div><img src="catalog/view/theme/commerca/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
										...
										<?php if ($attribute_groups) { ?>
										<div id="tab-attribute" class="tab-content animated" data-animation="fadeInLeft">
										...
										<?php if ($review_status) { ?>
											<div id="tab-review" class="tab-content animated" data-animation="fadeInLeft">
												<div id="review"></div>
											...
											<div class="container">
												...
												<div class="row carousel-container offer">
													<div class="col-xs-12 col-sm-12">
														...
														<h4 class="section-title"><?php echo $tab_related; ?> (<?php echo count($products); ?>)</h4>
